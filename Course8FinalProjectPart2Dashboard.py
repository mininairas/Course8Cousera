...
#if you need header alone uncomment this portion and commnet rest of the portion till last line of code
# app.layout = html.Div([
...
# 	html.H1("Historical Automobile Sales Statistics Dashboard", style={'textAlign':'center', 'color':'#961808', 'font-size':'24px', 'font-weight': 'bold'}),
#     html.Hr(),
# ])
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
            ...
            placeholder='Select a report type', style={'width': '100%', 'padding': '3px','font-size': '20px', 'text-align-last':'center'}
        )
    ]),
    ...
    html.Div([
        html.Div(
            ...
            style={'width': '100%', 'padding': '3px','font-size': '20px', 'text-align-last':'center'}
			#style={'width': '100%', 'padding': '3px','font-size': '20px', 'text-align-last':'center', 'display':'flex'}
        )
    ])
])
#---------------------------------------------------------------------------------------
